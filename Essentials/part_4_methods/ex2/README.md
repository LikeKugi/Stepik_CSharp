Задан класс **RobotGenerator**. Вызови его метод **Generate()** с любыми корретными аргументами
```
...
```
PS: в комментарии к решению можете прикладывать робота, который у вас получился 